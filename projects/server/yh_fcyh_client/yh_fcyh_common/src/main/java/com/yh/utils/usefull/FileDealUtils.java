package com.yh.utils.usefull;

import java.io.*;

/**
 * 读取某个文件夹下所有文件，并替换文件中指定字符串
 */
public class FileDealUtils {
    public static void main(String[] args) {
        String filePath = "C:\\Users\\yh\\Desktop\\SQL\\dml"; //给我你要读取的文件夹路径
        File outPath = new File("C:\\Users\\yh\\Desktop\\SQL\\dml_deal"); //随便给一个输出文件夹的路径(不存在也可以)
